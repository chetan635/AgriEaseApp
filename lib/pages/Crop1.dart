  ...
  void setup(var i, var j, var k){
    ...
    for(var m=0;m<Crop[i].length;m++){
      if(Crop[i][m]['District_Name']==j ){
       if(Crop[i][m]['Crop_Year'].toString()==k.toString()){
         Final_list.add(Crop[i][m]);
       }
      }
    }
    Navigator.pushNamed(context, "/Crop1_Final",arguments: {
                                    ...
                                    Card(
                                      ...
                                      child: Center(
                                        child: Column(
                                          children: [
                                            SizedBox(height: 5,),
                                            Text("Enter Year",style: GoogleFonts.zillaSlab(color: Colors.green[900],fontWeight: FontWeight.bold,fontSize: 30),),
                                            SizedBox(height: 5,),
                                            DropdownButton<String>(
